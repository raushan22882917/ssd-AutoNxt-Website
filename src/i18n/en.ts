  ...
  productPage: {
    ...
    tractorsList: {
      ...
      x30c2: {
        ...
        type: "30HP Premium Tractor",
        desc: "High-efficiency 30HP electric tractor for commercial farming with water-cooled motor, smart telematics, and fast charging.",
        specs: {
          power: "18 kW",
          battery: "30.72 kWh",
          runtime: "90 km Range",
  ...
  tractorDetailPage: {
    ...
    tractors: {
        ...
        features: [
          {
            ...
            desc: "At just 1,400 kg, the X25H2 causes minimal soil compaction — critical for precision farming and horticulture operations."
          },
        ],
        battery: [
          { label: "Chemistry", value: "Lithium Iron Phosphate (LFP)" },
      ...
      x30c2: {
        ...
        desc: "The X30C2 is AutoNxt's high-efficiency agricultural and industrial electric tractor. Engineered for commercial farming and medium-duty industrial tasks, it features a 18 kW electric motor, a 30.72 LFP battery pack, and a 90 km range. Designed to deliver peak torque and zero direct emissions for the most demanding environments.",
        ...
        specs: [
          ...
          { label: "Range", value: "90kms with Rated Load" },
          { label: "Charge Time", value: "2 Hr (Slow + Fast Charging)" },
          { label: "Max Torque", value: "156 NM" },
          { label: "Weight", value: "~1800kg" },
          { label: "Lifting Capacity", value: "1200kg" },
          ...
          { label: "Warranty", value: "3 years (inbuilt) + 2 years (Extended)" },
        ],
        features: [
          {
            title: "Nominal LFP Battery Pack",
            desc: "Advanced LFP battery chemistry with 30.72 KWH capacity and long life cycles, offering stable power delivery in extreme climates."
          },
          {
            title: "Remote Fleet Telematics",
            desc: "Real-time GPS tracking, battery status, motor health, and geo-fencing via the AutoNxt cloud platform — accessible from any device."
        ...
        battery: [
          ...
          { label: "Warranty", value: "5 yrs (whichever is earlier)" },
          { label: "Onboard Charger", value: "Yes (6.6kW Charger inbuilt)" },
        ],
        motor: [
        ...
        highlights: [
          ...
          "30.72 KWH LFP battery pack for consistent runtime",
          "Water cooled permanent magnet synchronous motor",
          "Capable of handling up to 10 tons max rated load",
