...
Google Play developer: autonxtdeveloper`,
  ...
  galleryPage: {
    ...
    eventHandoverDesc: "June 29, 2025 — AutoNxt delivered the X45C2 electric tractor at an official ceremony attended by government officials, police representatives, and media. A landmark moment in AutoNxt's journey to serve India's public institutions.",
    photos: [
      { alt: "Autonxt X45C2 at Golden Hour", label: "X45C2 — Field Edition", tag: "In the Field" },
      ...
      { alt: "Autonxt X45C2 with Commercial Trailer", label: "X45C2 — Commercial Hauling", tag: "Industrial" },
    ...
    events: [
      { alt: "AutoNxt X45C2 launch ceremony with officials and media", label: "Official Launch Address — Jun 29, 2025", tag: "Event" },
      { alt: "MOU signing ceremony — AutoNxt tractor handover", label: "Handover Ceremony & MOU Signing", tag: "Event" },
      { alt: "Officials blessing the AutoNxt X45C2 electric tractor", label: "X45C2 Inauguration Ceremony", tag: "Event" },
      { alt: "Dignitaries and team gathered around the AutoNxt X45C2", label: "X45C2 — Official Blessing", tag: "Event" },
      { alt: "AutoNxt X45C2 tractor surrounded by guests during ceremony", label: "X45C2 — Flag-Off Ceremony", tag: "Event" },
      { alt: "Tricolour balloon arch and X45C2 display at event", label: "Tricolour Launch Stage — Jun 29, 2025", tag: "Event" },
      { alt: "Close-up of AutoNxt X45C2 electric tractor at launch event", label: "AutoNxt X45C2 — Up Close", tag: "Product" }
    ],
    videos: [
