...
export default function Product() {
  ...
  const tractors = [
    ...
    },
    {
      slug: "x30c2",
      name: "X30C2",
      fullName: "AutoNxt X30C2",
      type: t.productPage.tractorsList.x30c2.type,
      badge: t.productPage.tractorsList.x30c2.badge,
      badgeGrad: "from-emerald-700 to-green-800",
      status: availableNowLabel,
      image: tractor3,
      glb: "/3dmodel/x45.glb",
      description: t.productPage.tractorsList.x30c2.desc,
      specs: [
        { icon: Zap, label: t.productPage.specs.power, value: t.productPage.tractorsList.x30c2.specs.power },
        { icon: BatteryCharging, label: t.productPage.specs.battery, value: t.productPage.tractorsList.x30c2.specs.battery },
        { icon: Activity, label: t.productPage.specs.runtime, value: t.productPage.tractorsList.x30c2.specs.runtime },
        { icon: Clock, label: t.productPage.specs.charging, value: t.productPage.tractorsList.x30c2.specs.charging },
      ],
