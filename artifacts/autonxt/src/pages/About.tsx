...
import facilityGarage from "@assets/3._Garage_Entry_–_After_Gate_1777731255751.jpg";
import facilityLeft from "@assets/7.LeftSideGateWall_1777731255752.jpg";
import facilityRight from "@assets/8.RightSideGateWall_1777731255752.jpg";
import fieldImg1 from "@assets/IMG-20250630-WA0001_1777739120122.jpg";
import fieldImg2 from "@assets/IMG-20250630-WA0002_1777739120122.jpg";
import fieldImg3 from "@assets/IMG-20250630-WA0003_1777739120122.jpg";
import fieldImg4 from "@assets/IMG-20250630-WA0004_1777739120122.jpg";
import fieldImg5 from "@assets/IMG-20250630-WA0005_1777739120122.jpg";
import fieldImg6 from "@assets/IMG-20250630-WA0006_1777739120122.jpg";
            ...
            <div className="pb-16">
              ...
              >
                {[
                  ...
                  { icon: Users, label: "Team Size", value: "16+" },
                ].map((f, i) => (
      ...
      <section className="py-24 bg-muted/40 border-y border-border">
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-14">
            <div>
              <motion.div className="flex items-center gap-3 mb-3" initial={{ opacity: 0, x: -16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <div className="h-px w-10 bg-primary rounded-full" />
            ...
            <motion.p className="text-muted-foreground max-w-sm lg:text-right" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
              We follow a rigorous process to ensure every AutoNxt tractor meets the highest standards of quality and performance.
            </motion.p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {PROCESS.map((p, i) => (
              <motion.div
                key={i}
                className="relative bg-card border border-border rounded-2xl p-7 hover:border-primary/30 hover:shadow-lg transition-all group overflow-hidden"
                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.07 }}
              >
                <span className="font-display text-[80px] font-black text-foreground/[0.04] select-none absolute -top-2 -right-1 leading-none">{p.step}</span>
                <div className="w-9 h-9 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center mb-4">
                  <span className="text-primary text-xs font-black">{p.step}</span>
                </div>
